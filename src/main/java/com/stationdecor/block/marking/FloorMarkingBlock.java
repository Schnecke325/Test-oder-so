 ...
 * Die Farbe (16 Varianten, siehe {@code client.render.FloorMarkingModels})
 * lässt sich nachträglich per Rechtsklick mit einem Farbstoff ändern.
 */
public class FloorMarkingBlock extends BaseEntityBlock {
    ...
    protected ItemInteractionResult useItemOn(ItemStack stack, BlockState state, Level level, BlockPos pos,
        ...
        if (!(level.getBlockEntity(pos) instanceof FloorMarkingBlockEntity blockEntity)) {
            return ItemInteractionResult.PASS_TO_DEFAULT_BLOCK_INTERACTION;
        }
